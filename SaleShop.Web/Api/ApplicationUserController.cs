...
using AutoMapper;
using SaleShop.Common.Exceptions;
...
namespace SaleShop.Web.Api
{
    ...
    public class ApplicationUserController : ApiControllerBase
    {
        ...
        public ApplicationUserController(IApplicationGroupService appGroupService,IApplicationRoleService appRoleService,ApplicationUserManager userManager,IErrorService errorService) : base(errorService)
        {
